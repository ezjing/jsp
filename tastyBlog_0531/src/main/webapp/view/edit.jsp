...
<main>
    <div class="container-md my-5">
        <form action="/tasty/EditDelete.do" method="post" enctype="multipart/form-data">
            <div class="d-flex mb-3">    <%--  d-flex는 부모태그에 적용, 버튼 이미지 인풋 등에 사용 가능  --%>
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="" style="width: 90%" value="${tour.title}">

            </div>
            <div class="d-flex mb-3">
                <label class="mt-1 form-label" for="content" style="width: 10%">내용 :</label>
                <textarea class="form-control" id="content" name="content" cols="30" rows="10" style="width: 90%">${tour.content}</textarea>
            </div>
            <div>
                ...
                <%--  수정되기 전의 파일 정보  --%>
                <input type="hidden" name="ofile" value="${tour.ofile}">
                <input type="hidden" name="sfile" value="${tour.sfile}">
                <input type="hidden" name="writeNum" value="${tour.writeNum}">
            </div>
            <div class="d-flex mb-3">
                <label class="align-self-center form-label" for="file" style="width: 10%">첨부 파일 :</label>
                <input type="file" class="form-control" id="file" name="file" placeholder="" style="width: 30%;" value="">
