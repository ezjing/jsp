        ...
        <div class="col-10">
            ...
            <table class="table table-hover text-center">
                ...
                <%
                    ...
                    ArrayList<TourDTO> list = dao.getSearch(request.getParameter("searchField"),
                ...
                %>
                <tr>
                    <td><%=list.get(i).getWriteNum()%></td>
                    <td><%=list.get(i).getName()%></td>
                    <%--현재 게시글에 대한 정보 --%>
                    <td><a href="/tasty/TourRead.do?num=<%=list.get(i).getWriteNum()%>" class="text-decoration-none"><%=list.get(i).getTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
                            .replaceAll(">", "&gt;").replaceAll("\n", "<br>")%>
                    </a></td>
                    <td><%=list.get(i).getDate()%></td>
                    <td><%=list.get(i).getVisit()%></td>
                </tr>
                <%
                    }
                %>
